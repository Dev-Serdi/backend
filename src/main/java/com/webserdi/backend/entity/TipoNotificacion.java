...
public enum TipoNotificacion {
    ...
    NUEVO_MENSAJE_EN_TICKET("Nuevo Mensaje", "Se ha hecho un nuevo comentario.", true),//listo
    NUEVO_TICKET_ASIGNADO("Ticket Nuevo Asignado", "Se te ha asignado un nuevo ticket.", true),//listo
    CAMBIO_ESTADO_TICKET("Cambio de Estado de Ticket", "El estado de un ticket relevante ha cambiado.", true),//listo
    TICKET_MODIFICADO("Ticket Modificado", "Un ticket relevante ha sido modificado.", true),//listo
    ...
    PERFIL_MODIFICADO("Perfil Modificado", "Tu perfil de usuario ha sido modificado.", true),//listo
    ...
    NUEVO_USUARIO_REGISTRADO("Nuevo Usuario Registrado", "Admin: Un nuevo usuario se ha registrado en el sistema.", false),//listo
